...
public class SumOddRange {
    ...
    public static void main(String[] args) {
        System.out.println(sumOdd(1, 10));// → should return 2500
...
which represent a range of numbers. The method should use a for loop to sum
...
end parameters have to be greater than 0. If those conditions are not satisfied
